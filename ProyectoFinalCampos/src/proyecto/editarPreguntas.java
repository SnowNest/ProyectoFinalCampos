 ...
 */
public class editarPreguntas extends javax.swing.JFrame {

    public editarPreguntas() {
    ...
    private void initComponents() {
        ...
        jlPreguntas.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jlPreguntas.setToolTipText("");
        jScrollPane1.setViewportView(jlPreguntas);

        jlRespuestas.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
